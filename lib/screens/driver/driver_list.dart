...
class _DriverListState extends State<DriverList> {
  ...
  GetListDriverProgress() async {
    try {
      List<Driver> temp = await ApiService.apiGetListDriverProgress();
      setState(() {
  ...
  GetListDriverSuccess() async {
    try {
      List<Driver> temp = await ApiService.apiGetListDriverSuccess();
      setState(() {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      driver.worksheetTerminalAgent!.isEmpty
                          ? '-'
